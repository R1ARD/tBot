...
'''-Можно сдать?
-Выйди''',
'Ласточка моя, зачем тебе корни?',
'В больших компаниях так не принято',
'''-Старые задания принимаю только на консультациях. 
-Так нет консультаций..
-А сдавать вовремя надо было!''',
'''-Какую работу ты хочешь сдать?
-Открывай и иди сюда.''']
